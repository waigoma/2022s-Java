...
public class RegisterConfirm_FX extends Application {
    ...
    private VBox leftVBox() {
        ...
        HBox name = createLabelField("Name: ", nameField);
        name.setAlignment(Pos.CENTER_RIGHT);
        name.setPadding(new Insets(0, 10, 0, 0));
        HBox password = createLabelField("Password: ", passwordField);
        password.setAlignment(Pos.CENTER_RIGHT);
        password.setPadding(new Insets(0, 10, 0, 0));
        HBox confirm = createLabelField("Confirm: ", confirmPasswordField);
        confirm.setAlignment(Pos.CENTER_RIGHT);
        confirm.setPadding(new Insets(0, 10, 0, 0));
        HBox email = createLabelField("Email: ", emailField);
